...
# Notes:
# - I pulled this to __https://github.com/afgranero/py-cv-proj;
...
#  - I did not committed the virtual environment to git though, I used pip freeze to create a __requirements.txt__;
#  - refer to __requirements.txt__ for the libraries versions needed;
